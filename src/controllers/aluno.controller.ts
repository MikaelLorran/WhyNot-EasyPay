...
export async function getAllAlunos(req: express.Request, res: express.Response) {
  const alunos = await alunoService.getAllAlunos()
  res.status(200).json(alunos)
}

export async function getAlunoById(req: express.Request, res: express.Response) {
  const { id } = req.params
...
export async function getAlunoByCpf(req: express.Request, res: express.Response) {
